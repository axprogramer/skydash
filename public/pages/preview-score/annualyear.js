...
export function annualyear(datas) {
            ...
            if (dbMonth == 'Annual Year') {
                if (primary_g_p1.includes(dbGrade)) {
                    ...
                    datas.forEach((d) => {
                        ...
                        var average1sr = d.val().average1sr;
                        var average2sr = d.val().average2sr;
                        var rank = d.val().rank_annualyear;

                        if (!average1sr) { average1sr = 0.00 };
                        if (!average2sr) { average2sr = 0.00 };

                        let total = parseFloat(average1sr) + parseFloat(average2sr)
                        ...
                        setTimeout(() => {
                            ...
                            let h = `
                                        ...
                                        <th class="border-dark text-center">មធ្យមភាគប្រចាំឆមាសទី១</th>
                                        <th class="border-dark text-center">មធ្យមភាគប្រចាំឆមាសទី២</th>
                                        <th class="border-dark text-center">មធ្យមភាគប្រចាំឆ្នាំ</th>
                            ...
                            let n = `
                                        ...
                                        <td class="border-dark text-center" contenteditable onclick="selectText(this)" data-average1sr="${N0}" id="${noSp}average1sr">${average1sr}</td>
                                        <td class="border-dark text-center" contenteditable onclick="selectText(this)" data-average2sr="${N0}" id="${noSp}average2sr">${average2sr}</td>
                            ...
                            //Update data
                            setTimeout(() => {
                                document.getElementById(`${noSp}average1sr`).addEventListener('input', () => {
                                    var d = document.getElementById(`${noSp}average1sr`).innerHTML;
                                    firebase
                                        .database()
                                ...
                                document.getElementById(`${noSp}average2sr`).addEventListener('input', () => {
                                    var d = document.getElementById(`${noSp}average2sr`).innerHTML;
                                    firebase
                                        .database()
                                        .ref(`SalaMOM/classes/` + `${dbyear}/` + `${grade_en}/` + id)
                                        .update({
                    ...
                    student_rank.forEach((student) => {
                        ...
                        var average1sr = student.average1sr;
                        var average2sr = student.average2sr;
                        ...
                        firebase
                            ...
                            .ref(`SalaMOM/classes/` + `${dbyear}/` + `${grade_en}/` + id)
                            .update({
                                averageannualyear: get_average,
                                rank_annualyear: rank,
                            });
                        let h = `
                                        ...
                                        <th class="border-dark text_table">មធ្យមភាគប្រចាំឆមាសទី១</th>
                                        <th class="border-dark text_table">មធ្យមភាគប្រចាំឆមាសទី២</th>
                                        <th class="border-dark text_table">មធ្យមភាគប្រចាំឆ្នាំ</th>
                        ...
                        let n = `
                                        ...
                                        <td class="border-dark text-center text_table fw-bold">${average1sr}</td>
                                        <td class="border-dark text-center text_table fw-bold">${average2sr}</td>
